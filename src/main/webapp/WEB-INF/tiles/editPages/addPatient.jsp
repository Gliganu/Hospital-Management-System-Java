...
<form:form id="details" action="${ADD_PATIENT_URL}" method="post"
	...
	<table>
		...
		<tr>
			<td>Name:</td>
			<td><form:input value="${currentPatient.name}" name="name" path="name" type="text" /></td>
			<td><form:errors path="name" cssClass="error" /></td>
		</tr>
		
		<tr>
			<td>Age:</td>
			<td><form:input value="${currentPatient.age}" id="age" name="age" path="age" type="text" /></td>
